...
{
	buttonNext = loadImage("https://saltysalt11242.github.io/p5jstutorial/p5jsPlatformerTutorial/images/button_next.png");
	pythagoras = loadImage("https://saltysalt11242.github.io/p5jstutorial/p5jsPlatformerTutorial/images/Screenshot 2019-01-07 at 12.58.51 AM.png");
	questionone = loadImage("https://saltysalt11242.github.io/p5jstutorial/p5jsPlatformerTutorial/images/Screenshot 2019-01-07 at 1.52.04 AM.png");
	questionzero = loadImage("https://saltysalt11242.github.io/p5jstutorial/p5jsPlatformerTutorial/images/Screenshot 2019-01-07 at 1.45.48 AM.png");
	questiontwo = loadImage("https://saltysalt11242.github.io/p5jstutorial/p5jsPlatformerTutorial/images/Screenshot 2019-01-07 at 2.10.13 AM.png");
	questionthree = loadImage("https://saltysalt11242.github.io/p5jstutorial/p5jsPlatformerTutorial/images/Screenshot 2019-01-07 at 2.33.23 AM.png");
}
...
//	console.log("platform ID "+platforms[c][7]);
	}
	// ------------------------------------- QUESTION 0 --------------------------------------------
...
function drawQuestionzero()
{
	image(questionzero,50,10,400,250)
}

function drawQuestionone()
{
	image(questionone,50,10,400,250)
}

function drawQuestiontwo()
{
	image(questiontwo,50,10,400,250)
}

function drawQuestionthree()
{
...
function drawWorldPythagoras(questionID)
{
...
{
	background(100);
	image(pythagoras,10,10,750,500);
	fill(255);
	image(buttonNext,640,540);
	if (mouseX >= 640 && mouseX <= 640 + 150 && mouseY >= 540 && mouseY <= 540 + 50 && mouseIsPressed)
	{
		canvasID = -2;
	}
...
function drawPythagorasscore()
{
	background(100);
	fill(255,255,255);
	textSize(36);
	text ("You got " + countCorrect + " out of 4 correct!", 150,100);

}

function drawScorePythagoras()
{
	background(100);
	fill(255,255,255);
	text(countCorrect,10,10);
	image (buttonNext,640,540);
	if (mouseX >= 640 && mouseX <= 640 + 150 && mouseY >= 540 && mouseY <= 540 + 50 && mouseIsPressed)
	{
		canvasID = -3;
